...
int assemble_account_number(int secret_modifier) {
    int assembled_number{zhang::bank_number_part(secret_modifier) + khan::bank_number_part(secret_modifier) + garcia::bank_number_part(secret_modifier)};
    return assembled_number;
}
    int assemble_code() {
        int assemble_red{zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment()};
        int assemble_blue{zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment()};
        return assemble_red * assemble_blue;
    }
}
